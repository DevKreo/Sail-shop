<template>
<div>
    <div class="rounded-full py-3 px-6 flex items-center justify-between mb-2" :class="[showRequestCall ?  'bg-blue-50' : 'bg-black']">
        <div class="inline-flex space-x-10 items-center" :class="[showRequestCall ?  'text-black' : 'text-white']">
            ...
            <span class="font-mono font-extrabold text-xl tracking-widest"> ЗАКАЗАТЬ ЗВОНОК </span>
        </div>
