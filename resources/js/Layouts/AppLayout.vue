<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white bg-gray-900 border-b border-gray-100">
                                ...
                                <jet-dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex bg-gray-500 items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
