    ...
    <div class="min-h-screen">
        <div class="flex">
            ...
            <div class="self-center ml-5">
                <div class="flex-shrink-0 flex items-center">
                    <span class="self-end font-black font-mono">
                        HORECA
                    </span>
                </div>
            </div>
                ...
                <div class="mx-auto">
                    <div class="flex justify-between h-24">
                        <div class="flex mx-auto">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <button :href="route('admin')" :active="route().current('admin')" class="rounded-full h-10 mt-8 w-10 bg-black border-0 flex items-center justify-center focus:bg-red-50 text-white focus-within:text-black">
