            ...
            <div class="flex-initial">
                <div class="flex-shrink-0 flex items-center">
                    <inertia-link :href="route('dashboard')">
                        <div class="hidden xl:block object-contain block h-24 w-24 bg-logo-texture"></div>
                    </inertia-link>
                </div>
            </div>
                    ...
                    <div class="flex justify-between h-24">
                        <div class="flex mx-auto">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <button :href="route('dashboard')" :active="route().current('dashboard')" class="rounded-full h-10 mt-8 w-10 bg-black border-0 flex items-center justify-center focus:bg-red-200 text-white focus-within:text-black">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <button :href="route('admin')" :active="route().current('admin')" class="rounded-full h-10 mt-8 w-10 bg-black border-0 flex items-center justify-center focus:bg-red-200 text-white focus-within:text-black">
